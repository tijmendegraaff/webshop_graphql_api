defmodule WebshopGraphqlApi.ProductsTest do
  use WebshopGraphqlApi.DataCase

  alias WebshopGraphqlApi.Products

  describe "porducts" do
    alias WebshopGraphqlApi.Products.Product
    ...
    test "list_porducts/0 returns all porducts" do
      product = product_fixture()
      assert Products.list_porducts() == [product]
    end
